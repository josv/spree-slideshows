...
desc 'Generate documentation for the slideshows extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SlideshowsExtension'
...
desc 'Test the slideshows extension.'
...
namespace :test do
  desc 'Functional test the slideshows extension.'
  ...
  desc 'Unit test the slideshows extension.'
